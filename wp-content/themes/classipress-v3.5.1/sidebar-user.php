		...
		<div class="shadowblock account-info">
			...
			<div class="avatar"><?php appthemes_get_profile_pic( $current_user->ID, $current_user->user_email, 140 ); ?></div>
				...
				<ul class="user-details">
					...
					<?php if ( ! empty( $current_user->twitter_id ) ) { ?><li><div class="dashicons-before twitterico"></div><a href="http://twitter.com/<?php echo esc_attr( $current_user->twitter_id ); ?>" target="_blank"><?php _e( 'Twitter', APP_TD ); ?></a></li><?php } ?>
