							...
							// <![CDATA[
								jQuery(document).ready(function() {
									function cp_show_price_slider(min_price, max_price, min_value, max_value, thousands) {
										...
										jQuery('#slider-range').slider( {
										  ...
										  slide: function(event, ui) {
												<?php switch ( $cp_curr_symbol_pos ) {
													case 'left' :
														?>jQuery('#amount').val('<?php echo $curr_symbol; ?>' + ui.values[0] + ' - <?php echo $curr_symbol; ?>' + ui.values[1]);<?php
														break;
													case 'left_space' :
														?>jQuery('#amount').val('<?php echo $curr_symbol; ?> ' + ui.values[0] + ' - <?php echo $curr_symbol; ?> ' + ui.values[1]);<?php
														break;
													case 'right' :
														?>jQuery('#amount').val(ui.values[0] + '<?php echo $curr_symbol; ?> - ' + ui.values[1] + '<?php echo $curr_symbol; ?>' );<?php
														break;
													case 'right_space' :
														?>jQuery('#amount').val(ui.values[0] + ' <?php echo $curr_symbol; ?> - ' + ui.values[1] + ' <?php echo $curr_symbol; ?>' );<?php
														break;
										...
										<?php switch ( $cp_curr_symbol_pos ) {
											case 'left' :
												?>jQuery('#amount').val('<?php echo $curr_symbol; ?>' + jQuery('#slider-range').slider('values', 0) + ' - <?php echo $curr_symbol; ?>' + jQuery('#slider-range').slider('values', 1));<?php
												break;
											case 'left_space' :
												?>jQuery('#amount').val('<?php echo $curr_symbol; ?> ' + jQuery('#slider-range').slider('values', 0) + ' - <?php echo $curr_symbol; ?> ' + jQuery('#slider-range').slider('values', 1));<?php
												break;
											case 'right' :
												?>jQuery('#amount').val(jQuery('#slider-range').slider('values', 0) + '<?php echo $curr_symbol; ?> - ' + jQuery('#slider-range').slider('values', 1) + '<?php echo $curr_symbol; ?>');<?php
												break;
											case 'right_space' :
												?>jQuery('#amount').val(jQuery('#slider-range').slider('values', 0) + ' <?php echo $curr_symbol; ?> - ' + jQuery('#slider-range').slider('values', 1) + ' <?php echo $curr_symbol; ?>');<?php
												break;
