...
function cp_custom_fields_meta_box() {
	...
	<script type="text/javascript">
		...
		<table class="form-table ad-meta-table">
			...
			<tr>
				<th style="width:20%"><label for="cp_sys_ad_conf_id"><?php _e( 'Ad Terms', APP_TD ); ?>:</label></th>
				<td><?php echo cp_get_price( $post->ID, 'cp_sys_total_ad_cost' ); ?> <?php _e( 'for', APP_TD ); ?> <?php echo esc_html( get_post_meta($post->ID, 'cp_sys_ad_duration', true) ); ?> <?php _e( 'days', APP_TD ); ?></td>
			</tr>
		...
		<tr>
			...
			<td>
				...
				<div class="image-meta">
					...
					<strong><?php _e( 'Upload Date:', APP_TD ); ?></strong> <?php echo mysql2date( get_option('date_format'), $image->post_date); ?><br />
